...
{
    cout << "Wordle Menu created..." << endl;
    men = 0;
    window.create(VideoMode(800, 800), "Wordle Menu");
    window.setFramerateLimit(60);

    font.loadFromFile("Wordle_menu.otf");
	...
	Leaderboard.setPosition(250, 450);
    ...
    instructions.setPosition(250, 525);
    ...
    exit.setPosition(250, 600);
    exit.setCharacterSize(30);
    exit.setOutlineThickness(1);

}

void WordleMenu::display_instructions()
{
    Text instructions;
...
int WordleMenu::display_menu(Leaderboard1* lead)
{
    window.create(VideoMode(800, 800), "Wordle Menu");
    window.setFramerateLimit(60);
    men = 1;
        ...
        while (window.pollEvent(e))
        {
            ...
            if (e.type == sf::Event::KeyPressed)
            {
                ...
                if (e.key.code == (Keyboard::Enter))
                {
					...
					else if (g == Color::White)
                    {
                        lead->loadLeaderboard(1);
...
int WordleMenu::display_categories()
{
...
void WordleMenu::displayAttempts()
{
	Text attempts;
	...
	attempts.setCharacterSize(40);
	attempts.setFillColor(Color::Black);
	attempts.setPosition(50, 50);
	attempts.setString("You made 0 attempts...");
	RenderWindow window(VideoMode(800, 800), "Attempts Made", Style::Close);
	while (window.isOpen())
	{
		Event e;
		while (window.pollEvent(e))
